...
const TYPES = [
  { key:'attendance', label:'Attendance Data',     desc:'Daily attendance (Manual/Internal)', cols:'Student_ID (Req), Student_Name (Req), Department, Year, Section, Date' },
  ...
  { key:'placement',  label:'Placement Data',      desc:'Company placement records', cols:'Student_ID (Req), Student_Name (Req), Department, Year, Section, Company, Package_LPA, Batch (Opt)' },
];
